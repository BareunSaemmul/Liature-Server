...
func init() {
	...
	gomniauth.WithProviders(
		naver.New("636296155193-a9abes4mc1p81752l116qkr9do6oev3f.apps.googleusercontent.com", "EVvuy0Agv4jWflml0pvC6-vI", "http://127.0.0.1:3000/auth/callback/google"),
	)
}

// AuthNaver 함수는 네이버 소셜 로그인 작업을 수행합니다.
func AuthNaver(w http.ResponseWriter, r *http.Request, action string, provider string) {
